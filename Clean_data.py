...
df = pd.read_csv(
    "C:\\Users\\Diana\\Downloads\\Raw_Loan_Account.csv",
    sep=';',  
    engine='python',
    on_bad_lines='skip', 
    quoting=3
...
df = df.drop_duplicates(subset=['LoanAccountId'], keep='last')

df.to_csv("C:\\Users\\Diana\\Visualstudio\\VSC\\Raw_Loan_Account_clean.csv", index=False, sep=';')
